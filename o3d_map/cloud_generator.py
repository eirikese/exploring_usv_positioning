...
# Constants
DXF_FILE_PATH = "C:/Users/eirik/OneDrive - NTNU/Semester 9/Prosjektoppgave/o3d_map/bay_lines.dxf"
OUTPUT_DIR = "C:/Users/eirik/OneDrive - NTNU/Semester 9/Prosjektoppgave/o3d_map/bay_evaluation_data"
POINTS_PER_METER = 1
NOISE_STD = 0.01
NUM_DATASETS = 4
SCALING_FACTOR = 0.01  # 1 => meters
TRANSLATION_RANGE = (-0, -0)
ROTATION_RANGE = (-0, -0)  # Degrees
X_MASK_RANGE = (-2, -0)  # (-2, -0.5)
...
def load_and_visualize_datasets(output_dir, num_datasets):
    ...
    for i in range(num_datasets):
        data_path = os.path.join(output_dir, f'data_{i}.npy')
...
def save_as_npy(data, index, directory):
    filename = os.path.join(directory, f'data_{index}.npy')
