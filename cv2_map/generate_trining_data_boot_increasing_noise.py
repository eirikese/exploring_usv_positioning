...
def generate_noisy_points(lines, num_points=num_points_per_line, noise_std=0.05):
    all_points = []
    for line in lines:
...
if __name__ == "__main__":
    ...
    for i in range(N):
        noise_std = noise_max * i / (N - 1)  # Increasing noise from 0 to 1 meter over N iterations
        original_noisy_points = generate_noisy_points(lines, noise_std=noise_std)
